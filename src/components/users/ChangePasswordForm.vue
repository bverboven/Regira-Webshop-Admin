<template>
    <form @submit.prevent="handleSubmit">
        ...
        <input type="text" class="form-control-plaintext" name="username" :value="username" autocomplete="username"
            readonly />
        <LoadingContainer :is-loading="isLoading">
            <div class="row mb-2">
                <div class="col">
                    <input type="password" class="form-control" name="currentPassword" v-model="model.currentPassword"
            ...
            <div class="row mb-2">
                <div class="col">
                    <input type="password" class="form-control" name="newPassword" v-model="model.newPassword"
            ...
            <div class="row mb-2">
                <div class="col">
                    <input type="password" class="form-control" name="passwordRepeat" v-model="passwordRepeat"
                        autocomplete="new-password" :class="{ 'is-invalid': !pwdMatches }" required />
