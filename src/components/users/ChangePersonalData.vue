            ...
            <div class="row mb-2">
                <div class="col">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="fname" v-model="model.givenName" placeholder="John"
            ...
            <div class="row mb-2">
                <div class="col">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="flame" v-model="model.lastName" placeholder="Doe"
