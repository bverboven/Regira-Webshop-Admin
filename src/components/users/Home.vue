<template>
    ...
    <Teleport to="#modals">
        <MyModal :is-visible="showChangePassword" :title="$t('auth.changePassword')" :show-footer="false"
            @close="showChangePassword = false" @cancel="showChangePassword = false">
            <ChangePasswordForm :username="$auth.authData?.name ?? ''" />
        </MyModal>
        <MyModal :is-visible="showChangePersonalData" :title="$t('auth.changePassword')" :show-footer="false"
            @close="showChangePersonalData = false" @cancel="showChangePersonalData = false">
            <ChangePersonalData />
        </MyModal>
    </Teleport>
</template>
