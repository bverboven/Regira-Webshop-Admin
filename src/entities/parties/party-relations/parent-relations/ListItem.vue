<template>
    <div class="card h-100">
        <div class="row g-0 bg-info bg-opacity-75">
            ...
            <div class="col-auto">
                <FormModalButton v-model="item" :child="child" :modalTitle="$t('party.child', { name: child?.$title })" class="btn btn-default"
                    ><Icon name="edit"
                /></FormModalButton>
        ...
        <div class="row g-0">
            <div class="col-auto bg-light">
                <PartyButton v-model="item.parent" class="btn btn-default" />
            </div>
            <div class="col p-2">
                {{ item.parent?.title }}
            </div>
        ...
        <div class="row g-0 opacity-50" v-for="contactData in item.parent?.contactData" :key="contactData.id">
            <div class="col-auto bg-light">
                <ActionButton class="btn btn-link cursor pointer" :item="contactData" />
            </div>
            <div class="col p-2">
